...
$sql=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='lflw' AND linker_name='$main_tl_name' order by id DESC");
...
<?php 
                     header("Refresh:1; url=follow-up.php");
          }
          else
          { ?>
             <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
