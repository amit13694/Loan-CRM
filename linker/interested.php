...
$sql=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='cnfrm' AND linker_name='$main_tl_name' AND MONTH(linkup_dat)=MONTH(CURDATE()) order by id DESC");
