...
$sql=mysqli_query($conn,"select add_documentor.target,add_documentor.id,add_documentor.name,add_documentor.contact,add_documentor.email,add_documentor.joining_date,admin.attendance,admin.login,admin.logout from add_documentor INNER JOIN admin ON add_documentor.tl_name=admin.tl_name AND add_documentor.email=admin.usename where add_documentor.tl_name='$name1'");
