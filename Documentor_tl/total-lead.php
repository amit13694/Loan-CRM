...
$sql=mysqli_query($conn,"select * from documentor_document where tl_name='$main_tl_name' order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
//---------------------------------------------------------------------------------------          
          $sql1=mysqli_query($conn,"update documentor_document set name='$empname1',address='$empadd1',zip_code='$empzip1',contact='$empnumb1',email='$empemail1',adhar_number='$empuid1',pan_number='$emppan1',pan_image='$pan_filename',adhar_image='$uid_filename',bank_image='$bank_filename',photo='$user_filename',other_document='$other_filename',dob='$empdob1',qualification='$empqualification1',civil_report='$empcivil1',comment='$empcomment1',follow_up='$empfollow1',follow_cmnt='$follow_cmnt1' where id='$emp_id1'");
          if($sql1!=false)
          {
               ...
               <div class="row">
                    ...
                    <div class="col-md-2">
                         <div class="form-group">
                              ...
                              <input type="text" name="photo" value="" class="form-control" id="empphoto">
                         </div>
                    </div>
                    <div class="col-md-3">
                         <div class="form-group">
