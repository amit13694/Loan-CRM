...
$sql=mysqli_query($conn,"select * from add_documentor where tl_name='$tl_name1'");
$cmplt_target=mysqli_query($conn,"select * from add_documentor where tl_name='$tl_name1'");
...
<div class="col-md-10 content">
    ...
    <form method="POST" action="download-callerwise.php">
      <button type="submit" name="callerwise" class="btn btn-primary btn-sm float-left">Download</button>
        ...
        <div id="doc_lead" class="collapse">oooo</div>
    </div>
 </div>
</div>
</div>
