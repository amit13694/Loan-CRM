...
$sql=mysqli_query($conn,"select * from add_documentor");
$cmplt_target=mysqli_query($conn,"select * from add_documentor");
...
<div class="col-md-10 content">
    ...
    <form method="POST" action="download-documentorwise.php">
