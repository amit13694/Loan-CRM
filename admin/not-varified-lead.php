...
$sql=mysqli_query($conn,"select * from documentor_document where  varifier_status='no' order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
$follow_up=array();
$id=array();
$varifier_status=array();
while($row=mysqli_fetch_array($sql,MYSQLI_ASSOC))
{
  $varifier_status[]=$row['varifier_status'];
  $id[]=$row['id'];
  $name[]=$row['name'];
$address[]=$row['address'];
...
if(isset($_POST['sub']))
{
          ...
          $sql1=mysqli_query($conn,"update documentor_document set name='$empname1',address='$empadd1',zip_code='$empzip1',contact='$empnumb1',email='$empemail1',adhar_number='$empuid1',pan_number='$emppan1',dob='$empdob1',qualification='$empqualification1',civil_report='$empcivil1',follow_up='$empfollow1',tl_name='$main_tl_name' ,varifier_status='$linkup_status1' where id='$emp_id1'");
          if($sql1!=false)
          { ?>
          ...
          <?php 
                  for($i=0;$i<count($name);$i++)
                  {
                    ...
                    <tr class="text-light" style="background:#6D6E6A;" >
                      ...
                      <td><?php echo $varifier_status[$i];?></td>
    ...
    $(document).on('click' ,'.data_edit' , function(){
       ...
       $.ajax({
        ...
        success:function(data)
        {
          ...
          $('#emp_id').val(data.id);
           $('#linkup').val(data.varifier_status);
          $('#edit').modal('show');
        }
