...
//   $from1=$_POST['from'];
//   $to1=$_POST['to'];
//   $sql=mysqli_query($conn,"select * from documentor_document where (varifier_status='NULL' OR varifier_status='') AND (when_added BETWEEN $from1 AND $to1) ");
// }
$sql=mysqli_query($conn,"select * from documentor_document where varifier_status='NULL' OR varifier_status='' order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
if(isset($_POST['sub']))
{
          ...
          $sql1=mysqli_query($conn,"update documentor_document set name='$empname1',address='$empadd1',zip_code='$empzip1',contact='$empnumb1',email='$empemail1',adhar_number='$empuid1',pan_number='$emppan1',dob='$empdob1',qualification='$empqualification1',civil_report='$empcivil1',follow_up='$empfollow1' where id='$del'");
          if($sql1!=false)
          { ?>
          ...
          <?php 
                     header("Refresh:1; url=admin-documentor.php");
          }
          else
          { ?>
             <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
         ...
         <?php }
                        ...
                        if(isset($_POST['delete_sub']))
                      {
                        ...
                        if($sql4!=false)
                        {
                          header("location:admin-documentor.php");
                        }
                        else
                        { ?>
                           <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
...
<div class="container-fluid">
   ...
   <!--    <h4 class="text-light text-center">search Document</h4>
    
      <form class="form-inline justify-content-center" method="POST">
        <label for="from" class="text-light">From</label>
        <input type="date" name="from" class="form-control">
        <label for="from" class="text-light" style="margin-left: 10px;">To</label>
