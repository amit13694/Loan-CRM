<?php
$itemid = mysql_real_escape_string($_REQUEST['email']);
$sql=mysqli_query($conn,"select * from documentor_document where  DAY(when_added)=DAY(CURDATE()) order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
?>
 	   	<h4 class="text-light text-center">Today Document</h4>
 	   	<div class="table-responsive">
 	   	<div class="table-responsive" style="overflow-x: auto;" style="color: white;">
 	   	<table class="table table-hover table-bordered table-sm dv-table" id="myTable_doc">
 	   		<thead>
