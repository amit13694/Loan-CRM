...
if(isset($_POST['sub']))
{
	...
	{
		$sql=mysqli_query($conn,"insert into admin(usename,name,password,status,tl_name,varifier_unique,logout,sidenav,container,header)values('$empemail','$empname','$emppass','varifier','$tl1','$unique',NOW(),'#343A40','#6D6E6A','#343A40')");
		$sql1=mysqli_query($conn,"insert into add_varifier(name,contact,email,joining_date,varifier_pass,tl_name,unique_number,target)values('$empname','$empnumber','$empemail','$empdate','$emppass','$tl1','$unique','0')")or trigger_error("sql error".mysqli_error($conn),E_USER_ERROR);
		if($sql1!=false && $sql!=false)
		{ ?>
     ...
     <div class="col-md-10 content">
     	<div class="card mx-auto" style="width:60%;">
     		<div class="card-header bg-dark">
     			<h4 class="text-light text-center">ADD VARIFIER</h4>
     		</div>
     		<div class="card-body">
     			<form method="POST">
