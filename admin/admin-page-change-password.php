...
$sql=mysqli_query($conn,"select password from admin where usename='$admin_name' AND status='admin'");
...
if(isset($_POST['sub']))
{
	...
	{ 
		...
		{
			$sql=mysqli_query($conn,"update admin set password='$new' where usename='$admin_name' AND status='admin'");
      $sql2=mysqli_query($conn,"update crm_status set password='$new' where username='$admin_name'");
