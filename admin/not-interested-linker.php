...
$sql=mysqli_query($conn,"select * from documentor_document where  linkup_cnfrm='ncnfrm' order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
if(isset($_POST['sub']))
{
          ...
          $sql1=mysqli_query($conn,"update documentor_document set name='$empname1',address='$empadd1',zip_code='$empzip1',contact='$empnumb1',email='$empemail1',adhar_number='$empuid1',pan_number='$emppan1',dob='$empdob1',qualification='$empqualification1',civil_report='$empcivil1',follow_up='$empfollow1',tl_name='$main_tl_name' ,linkup_cnfrm='$linkup_status1' where id='$emp_id1'");
          if($sql1!=false)
          { ?>
...
<?php 
                     header("Refresh:1; url=not-interested-linker.php");
          }
          else
          { ?>
             <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
...
if(isset($_POST['delete_sub']))
{
  ...
  if($sql4!=false)
  {
    header("location:not-interested-linker.php");
  }
  else
  { ?>
     <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
        ...
        <div class="form-group">
          ...
          <input type="number" name="emppan" class="form-control" id="emppan">
               ...
               <div class="form-group">
                    ...
                    <input type="text" name="linkup" class="form-control" id="linkup">
               </div>
