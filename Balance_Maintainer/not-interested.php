...
$sql=mysqli_query($conn,"select * from documentor_document where comment='NINST' AND balance_maintainer_name='$main_tl_name' AND MONTH(balance_dat)=MONTH(CURDATE())");
