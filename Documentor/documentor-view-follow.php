...
$sid=$_SESSION['sid'];
$sql=mysqli_query($conn,"select * from documentor_document where documentor_name='$sid' AND documentor_status='flw' AND MONTH(when_added)=MONTH(CURDATE()) order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
$id=array();
$follow_cmnt=array();
$documentor_status=array();
while($row=mysqli_fetch_array($sql,MYSQLI_ASSOC))
{
  $documentor_status[]=$row['documentor_status'];
...
if(isset($_POST['sub']))
{
          ...
          @$documentor_status1=$_POST['documentor_status'];
  ...
  //---------------------------------------------------------------------------------------------------
          $sql1=mysqli_query($conn,"update documentor_document set name='$empname1',address='$empadd1',zip_code='$empzip1',contact='$empnumb1',email='$empemail1',adhar_number='$empuid1',pan_number='$emppan1',pan_image='$pan_filename',adhar_image='$uid_filename',bank_image='$bank_filename',photo='$user_filename',other_document='$other_filename',dob='$empdob1',qualification='$empqualification1',civil_report='$empcivil1',follow_up='$empfollow1',follow_cmnt='$follow_cmnt1',documentor_status='$documentor_status1' where id='$emp_id1'");
          if($sql1!=false)
          {
...
<?php 
                     header("Refresh:1; url=documentor-view-follow.php");
          }
          else
          { ?>
             <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
...
if(isset($_POST['delete_sub']))
{
  ...
  if($sql4!=false)
  {
    header("location:documentor-view-follow.php");
 	   		...
 	   		<tbody>
                  ...
                  { ?>
                    <tr class="text-light" style="background: blue;">
                      ...
                      <td><?php echo $documentor_status[$i];?></td>
                      <td>
        ...
        <div class="form-group">
          ...
          <input type="number" name="emppan" class="form-control" id="emppan">
               ...
               <div class="form-group">
                    ...
                    <input type="text" name="documentor_status" class="form-control" id="documentor_status">
               </div>
               <div class="form-group">
       ...
       $.ajax({
        ...
        success:function(data)
        {
          $('#follow_cmnt').val(data.follow_cmnt);
           $('#emp_id').val(data.id);
           $('#documentor_status').val(data.documentor_status);
