...
$sql=mysqli_query($conn,"select password from admin where usename='$admin_name' AND status='documentor'");
...
if(isset($_POST['sub']))
{
	...
	{ 
		...
		{
			$sql=mysqli_query($conn,"update admin set password='$new' where usename='$admin_name' AND status='documentor'");
      $sql1=mysqli_query($conn,"update add_documentor set docu_password='$new' where email='$admin_name'");
