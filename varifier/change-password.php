...
$sql=mysqli_query($conn,"select password from admin where usename='$admin_name' AND status='varifier'");
...
if(isset($_POST['sub']))
{
	...
	{ 
		...
		{
			$sql=mysqli_query($conn,"update admin set password='$new' where usename='$admin_name' AND status='varifier'");
      $sql1=mysqli_query($conn,"update add_varifier set varifier_pass='$new' where email='$admin_name'");
