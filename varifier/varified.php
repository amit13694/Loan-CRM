...
$sid=$_SESSION['sid'];
$sql=mysqli_query($conn,"select * from documentor_document where varifier_status='yes' AND varifier_name='$sid' AND MONTH(varified_dat)=MONTH(CURDATE()) order by id DESC");
...
<?php 
                     header("Refresh:1; url=varified.php");
          }
          else
          { ?>
             <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
