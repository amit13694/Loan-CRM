...
$sql=mysqli_query($conn,"select * from documentor_document where varifier_status='' AND documentor_status='' AND varifier_flw='' order by id DESC LIMIT $limit_target");
...
//-------------------------------------------------
$fetching_monthwise_target_left=mysqli_query($conn,"select DAY(target_add_month) AS t, MONTH(target_add_month) AS p from add_varifier where email='$sid'");
...
if($month!=date('m'))
{
  $update_all_data=mysqli_query($conn,"update add_varifier set day_1='0',day_2='0',day_3='0',day_4='0',day_5='0',day_6='0',day_7='0',day_8='0',day_9='0',day_10='0',day_11='0',day_12='0',day_13='0',day_14='0',day_15='0',day_16='0',day_17='0',day_18='0',day_19='0',day_20='0',day_21='0',day_22='0',day_23='0',day_24='0',day_25='0',day_26='0',day_27='0',day_28='0',day_29='0',day_30='0',day_31='0' where email='$sid'");
}
//------------------------------------------------------------------
//check is the comment section is blank or not
$fetch_data=mysqli_query($conn,"select target_cmplt,month_target_cmplt,target,today_target from add_varifier where email='$sid'");
                      ...
                      Congratulation!! Your Traget Completed
                                ...
                                <?php
                                $add_benefit=mysqli_query($conn,"update add_varifier set day_$day='1' where email='$sid' ");
...
<?php 
                     header("Refresh:1; url=documentor-view.php");
          }
          else
          { ?>
             <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
...
if(isset($_POST['delete_sub']))
{
  ...
  if($sql4!=false)
  {
    header("location:documentor-view.php");
