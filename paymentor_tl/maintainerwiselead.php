...
$sql=mysqli_query($conn,"select * from add_paymentor where tl_name='$tl_name1'");
$cmplt_target=mysqli_query($conn,"select * from add_paymentor where tl_name='$tl_name1'");
...
<div class="col-md-10 content">
    ...
    <form method="POST" action="balancewise_download.php">
