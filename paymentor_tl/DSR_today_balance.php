<?php
$sql=mysqli_query($conn,"select * from documentor_document where comment='INST' AND DAY(when_added)=DAY(CURDATE()) order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
?>
 	   	<h4 class="text-light text-center">Today Balance</h4>
