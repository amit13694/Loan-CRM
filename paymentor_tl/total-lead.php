...
$sql=mysqli_query($conn,"select * from documentor_document where varifier_status='yes' AND linkup_cnfrm='cnfrm' AND (comment='' or comment='NULL') order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
if(isset($_POST['sub']))
{
    ...
    $user_filename=$empname1.".".$ext_user;
          $sql1=mysqli_query($conn,"update documentor_document set name='$empname1',address='$empadd1',zip_code='$empzip1',contact='$empnumb1',email='$empemail1',adhar_number='$empuid1',pan_number='$emppan1',pan_image='$pan_filename',adhar_image='$uid_filename',bank_image='$bank_filename',photo='$user_filename',other_document='$other_filename',dob='$empdob1',qualification='$empqualification1',civil_report='$empcivil1',comment='$empcomment1',follow_up='$empfollow1',tl_name='$main_tl_name',balance_dat=NOW(),follow_cmnt='$follow_cmnt1' where id='$emp_id1'");
          if($sql1!=false)
          {
