...
$today_varified_document=mysqli_query($conn,"select * from documentor_document where varifier_status='yes' AND DAY(when_added)=DAY(CURDATE()) AND tl_name='$tl_name'");
$count_today_varified_document=mysqli_num_rows($today_varified_document);
//today not varified document
$today_not_varified_document=mysqli_query($conn,"select * from documentor_document where varifier_status='no' AND DAY(when_added)=DAY(CURDATE()) AND tl_name='$tl_name'");
$count_today_not_varified_document=mysqli_num_rows($today_not_varified_document);
//today follow
$today_varified_follow=mysqli_query($conn,"select * from documentor_document where varifier_status='vflw' AND DAY(when_added)=DAY(CURDATE()) AND tl_name='$tl_name'");
$count_varified_follow=mysqli_num_rows($today_varified_follow);
//today linkup
$today_linkup=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='cnfrm' AND DAY(when_added)=DAY(CURDATE()) AND tl_name='$tl_name'");
$count_today_linkup=mysqli_num_rows($today_linkup);
//today linkup follow
$today_linkup_follow=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='lflw' AND DAY(when_added)=DAY(CURDATE()) AND tl_name='$tl_name'");
$count_today_linkup_follow=mysqli_num_rows($today_linkup_follow);
//linkup NI
$today_linkup_NI=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='ncnfrm' AND DAY(when_added)=DAY(CURDATE()) AND tl_name='$tl_name'");
