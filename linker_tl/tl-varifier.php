...
$sql=mysqli_query($conn,"select add_varifier.target,add_varifier.id,add_varifier.name,add_varifier.contact,add_varifier.email,add_varifier.joining_date,admin.attendance,admin.login,admin.logout from add_varifier INNER JOIN admin ON add_varifier.tl_name=admin.tl_name AND add_varifier.email=admin.usename");
...
if(isset($_POST['sub']))
{
$sql1=mysqli_query($conn,"update add_linker set name='$empname1',contact='$empnumber1',email='$empemail1',joining_date='$empdate1',target='$target2' where id='$id1'");
if($sql1!=false)
{ ?>
