...
$sql=mysqli_query($conn,"select * from documentor_document where  tl_name='$main_tl_name' AND linkup_cnfrm='cnfrm' AND MONTH(linkup_dat)=MONTH(CURDATE()) order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
