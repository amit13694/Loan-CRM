...
$sql=mysqli_query($conn,"select * from documentor_document where varifier_status='' AND varifier_flw='vflw' AND MONTH(varified_dat)=MONTH(CURDATE()) AND tl_name='$sid'  order by id DESC");
