...
$sql=mysqli_query($conn,"select * from add_varifier where tl_name='$tl_name1'");
$cmplt_target=mysqli_query($conn,"select * from add_varifier where tl_name='$tl_name1'");
...
<div class="col-md-10 content">
    ...
    <form method="POST" action="varifierwise_download.php">
