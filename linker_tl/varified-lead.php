...
$sql=mysqli_query($conn,"select * from documentor_document where varifier_status='yes' AND tl_name='$main_tl_name' AND MONTH(varified_dat)=MONTH(CURDATE()) order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
if(isset($_POST['sub']))
{
    ...
    $user_filename=$empname1.".".$ext_user;
          ...
          <?php 
                     header("Refresh:1; url=varified-lead.php");
          }
          else
          { ?>
             <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
         ...
         <?php }
                        ...
                        if(isset($_POST['delete_sub']))
                      {
                        ...
                        if($sql4!=false)
                        {
                          header("location:varified-lead.php");
                        }
                        else
                        { ?>
                           <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
