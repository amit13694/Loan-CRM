...
$sql=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='lflw' AND DAY(when_added)=DAY(CURDATE()) AND tl_name='$tl_name' order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
?>
 	   	<h4 class="text-light text-center">Today Linkup Follow</h4>
