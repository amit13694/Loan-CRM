...
$sql=mysqli_query($conn,"select add_linker.target,add_linker.id,add_linker.name,add_linker.contact,add_linker.email,add_linker.joining_date,admin.attendance,admin.login,admin.logout from add_linker INNER JOIN admin ON add_linker.tl_name=admin.tl_name AND add_linker.email=admin.usename");
