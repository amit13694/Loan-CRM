...
$sql=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='ncnfrm' AND tl_name='$main_tl_name' AND MONTH(linkup_dat)=MONTH(CURDATE()) order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
...
if(isset($_POST['sub']))
{
    ...
    $user_filename=$empname1.".".$ext_user;
          ...
          $sql1=mysqli_query($conn,"update documentor_document set name='$empname1',address='$empadd1',zip_code='$empzip1',contact='$empnumb1',email='$empemail1',adhar_number='$empuid1',pan_number='$emppan1',pan_image='$pan_filename',adhar_image='$uid_filename',bank_image='$bank_filename',photo='$user_filename',other_document='$other_filename',dob='$empdob1',qualification='$empqualification1',civil_report='$empcivil1',follow_up='$empfollow1',tl_name='$main_tl_name' ,linkup_cnfrm='$empcomment1',follow_cmnt='$follow_cmnt1' where id='$emp_id1'");
          if($sql1!=false)
          { 
    ...
    if(isset($_POST['delete_sub']))
                      {
                        ...
                        if($sql4!=false)
                        {
                          header("location:not-interested.php");
                        }
                        else
                        { ?>
                           <div class="alert alert-light alert-dismissible" style="width:30%; margin-left: 44%;">
        ...
        <div class="form-group">
          ...
          <input type="number" name="emppan" class="form-control" id="emppan">
               ...
               <div class="form-group">
                    ...
                    <input type="datetime-local" name="follow_cmnt" class="form-control" id="follow_cmnt">
               </div>
                    <div class="form-group">
