...
$sql=mysqli_query($conn,"select * from documentor_document where linkup_cnfrm='lflw' AND tl_name='$main_tl_name' AND MONTH(linkup_dat)=MONTH(CURDATE()) order by id DESC");
$name=array();
$address=array();
$zip_code=array();
$contact=array();
